...
const config: Config = {
  ...
  theme: {
    extend: {
      ...
      backgroundImage: {
        'gold-gradient': 'linear-gradient(135deg, #C9A56A 0%, #E8C98A 40%, #C9A56A 70%, #A07840 100%)',
        'gold-radial': 'radial-gradient(ellipse at center, #E8C98A 0%, #C9A56A 50%, #8A6030 100%)',
