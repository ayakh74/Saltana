...
export default function PortalPage() {
  ...
  return (
    <div className="relative min-h-screen flex items-center justify-center overflow-hidden bg-[#0a0804]">
      {/* Ambient radial glows */}
      <div className="pointer-events-none absolute inset-0">
        <div className="absolute top-0 left-1/2 -translate-x-1/2 w-[900px] h-[500px] rounded-full bg-gold-600/5 blur-[120px]" />
        <div className="absolute bottom-0 right-1/4 w-[500px] h-[400px] rounded-full bg-gold-500/4 blur-[100px]" />
      </div>
      ...
      <div className="relative z-10 w-full max-w-md mx-4">
        {/* Gold shimmer border */}
        <div className="absolute -inset-[1px] rounded-2xl bg-gradient-to-b from-gold-500/40 via-gold-700/10 to-gold-500/5" />

        <div className="relative rounded-2xl bg-gradient-to-b from-[#16120a] to-[#0e0c07] px-8 py-12 shadow-[0_40px_80px_rgba(0,0,0,0.7)]">
          ...
          <p className="mt-10 text-center text-[10px] tracking-[0.15em] text-gold-700/25 uppercase">
            Saltana Restaurant &mdash; Private Access
          </p>
        </div>
      </div>
    </div>
