    ...
    <div className="min-h-screen bg-obsidian flex items-center justify-center px-4">
      ...
      <div className="relative w-full max-w-sm">
        <div className="text-center mb-10">
          <Image src="/logo.png" alt="Saltana" width={80} height={80} className="mx-auto mb-4 object-contain drop-shadow-[0_0_20px_rgba(201,165,106,0.4)]" />
          <h1 className="text-2xl font-bold text-cream/90">Admin Dashboard</h1>
          <p className="text-cream/40 text-sm mt-1">سلطنة · Saltana</p>
        </div>
