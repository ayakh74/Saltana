    ...
    <section className="relative min-h-screen flex flex-col items-center justify-center overflow-hidden bg-obsidian">
      ...
      <div className="absolute inset-0 pointer-events-none z-0">
        ...
        <div
          ...
          style={{ background: 'radial-gradient(circle, #E8C98A, transparent 70%)' }}
        />
        <div
      ...
      <div className="relative z-10 flex flex-col items-center text-center px-4 max-w-4xl mx-auto">
        ...
        {/* Ornamental divider */}
        <div
          className={`transition-all duration-1000 delay-600 flex items-center gap-4 mb-6 w-full max-w-sm ${loaded ? 'opacity-100' : 'opacity-0'}`}
        >
          <div className="flex-1 h-px bg-gradient-to-r from-transparent to-gold-DEFAULT/40" />
          <svg width="20" height="20" viewBox="0 0 20 20" fill="#C9A56A" opacity="0.6">
            <path d="M10 0L12 8L20 10L12 12L10 20L8 12L0 10L8 8L10 0Z" />
          </svg>
          <div className="flex-1 h-px bg-gradient-to-l from-transparent to-gold-DEFAULT/40" />
        </div>
        ...
        >
          ...
          <Link
            href="/menu"
            className="btn-outline-gold px-8 py-4 text-sm font-semibold tracking-[0.15em] rounded-sm uppercase min-w-[200px] text-center"
          >
            {t('cta_menu')}
          </Link>
        </div>
